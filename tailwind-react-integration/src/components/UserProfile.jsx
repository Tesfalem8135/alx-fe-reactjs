...
export default function UserProfile() {
  return (
    <div className="mx-auto sm:p-4 md:p-8 sm:max-w-xs md:max-w-sm bg-white rounded-xl shadow-md flex flex-col items-center space-y-4">
      {/* Profile Image */}
      <img
        src="/profile.jpg"
        alt="User Profile"
      ...
      <div className="text-center">
        <h2 className="font-bold sm:text-lg md:text-xl">John Doe</h2>
